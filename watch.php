	...
	<body>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="watch.php?action=add&id=<?php echo $row["id"]; ?>&image=<?php echo $row["image"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="watch.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
